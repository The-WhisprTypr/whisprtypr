...
- Keep feedback focused on ideas, code, and project outcomes.
- Help newcomers find the right context.
...
To report a concern, open a private security advisory when appropriate or contact the maintainers through the repository owner profile. Reports will be handled with care and confidentiality where possible.
